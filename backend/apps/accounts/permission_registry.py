...
PERMISSION_REGISTRY: list[dict[str, str]] = [
    ...
    {
        "codename": "can_view_team",
        "name": "View project teams",
        "category": "Reports & users",
        "description": "See people across your projects, their progress, and generate reports.",
    },
    {
        "codename": "can_view_users",
        "name": "View users",
        "category": "Reports & users",
        "description": "Browse the organization-wide user directory.",
    },
    {
